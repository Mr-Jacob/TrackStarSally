...
public final class Constants {
  ...
  //default alliance blue, changed on startup
  public boolean isBallRed = false;

   //Drive motor Hardware ID's, set when ready
    public static  int left_MasterDrive = 0;
    public static boolean left_MasterDrive_isInverted = false;
    ...
    public static boolean right_SlaveDrive_isInverted = true;
   ...
   //shooter ID's
    ...
    public static double motorVelocity = 340;
   ...
   //shooter gains & timeouts
    ...
    public static boolean k_intake_bands_viktor_isInverted = false;
      ...
      //Indexer Constants
        ...
        public static boolean k_index_band_SensorPhase = true;
        ...
        public static final int ballIncrement = 800; //change later, moves quarter revolution bc 2048 = 1 rev
